# ubuntu 20.10 template, by default use password store in vault
...
#source bloc
source "vsphere-iso" "u2010_autoinstall" {
  #VM definition
  vm_name              = "ubuntu-2010-amd64-v1XXX"
  notes                = "build template v04 ubuntu 2010 via autoinstall"  
  #iso ubuntu 20.10 autoinstall
  iso_checksum         = "sha256:defdc1ad3af7b661fe2b4ee861fb6fdb5f52039389ef56da6efc05e6adfe3d45"
  iso_urls             = ["iso/ubuntu-20.10-live-server-amd64.iso", "https://releases.ubuntu.com/20.10/ubuntu-20.10-live-server-amd64.iso"]
...
build {
  sources = ["source.vsphere-iso.u2010_autoinstall"]
