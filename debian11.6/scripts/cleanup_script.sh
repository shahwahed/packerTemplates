...
echo "deb http://ftp.fr.debian.org/debian/ bullseye-backports main" >>/etc/apt/sources.list.d/backport.list
DEBIAN_FRONTEND=noninteractive
apt-get -qq -o=Dpkg::Use-Pty=0 update
apt-get -qq -o=Dpkg::Use-Pty=0 install -y -t bullseye-backports cloud-init
...
# cleanup dhcp old lease
rm /var/lib/dhcp/dhclient.*

#cleanup netplan network
rm /etc/netplan/*
